...
test = prep.prepare_ds_to_sales_prediction(test, train)

train = prep.prepare_ds_to_sales_prediction(train, train)
...
ds_handler.save_dataset(final, "mean_var_on_sales_from_tain.csv")